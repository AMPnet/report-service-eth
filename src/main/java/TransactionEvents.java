...
public class TransactionEvents extends org.web3j.tx.Contract {
    ...
    public static final org.web3j.abi.datatypes.Event CREATEPAYOUT_EVENT = new org.web3j.abi.datatypes.Event("CreatePayout",
            java.util.Arrays.<org.web3j.abi.TypeReference<?>>asList(new org.web3j.abi.TypeReference<org.web3j.abi.datatypes.Address>() {}, new org.web3j.abi.TypeReference<org.web3j.abi.datatypes.generated.Uint256>() {}, new org.web3j.abi.TypeReference<org.web3j.abi.datatypes.generated.Uint256>() {}, new org.web3j.abi.TypeReference<org.web3j.abi.datatypes.generated.Uint256>() {}));
    ;
    ...
    public java.util.List<TransactionEvents.CancelInvestmentEventResponse> getCancelInvestmentEvents(org.web3j.protocol.core.methods.response.TransactionReceipt transactionReceipt) {
        ...
        for (org.web3j.tx.Contract.EventValuesWithLog eventValues : valueList) {
            ...
            typedResponse.tokenAmount = (java.math.BigInteger) eventValues.getNonIndexedValues().get(0).getValue();
            typedResponse.tokenValue = (java.math.BigInteger) eventValues.getNonIndexedValues().get(1).getValue();
            typedResponse.timestamp = (java.math.BigInteger) eventValues.getNonIndexedValues().get(2).getValue();
    ...
    public io.reactivex.Flowable<TransactionEvents.CancelInvestmentEventResponse> cancelInvestmentEventFlowable(org.web3j.protocol.core.methods.request.EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new io.reactivex.functions.Function<org.web3j.protocol.core.methods.response.Log, TransactionEvents.CancelInvestmentEventResponse>() {
            @Override
            public TransactionEvents.CancelInvestmentEventResponse apply(org.web3j.protocol.core.methods.response.Log log) {
    ...
    public io.reactivex.Flowable<TransactionEvents.ClaimEventResponse> claimEventFlowable(org.web3j.protocol.core.methods.request.EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new io.reactivex.functions.Function<org.web3j.protocol.core.methods.response.Log, TransactionEvents.ClaimEventResponse>() {
            @Override
            public TransactionEvents.ClaimEventResponse apply(org.web3j.protocol.core.methods.response.Log log) {
    ...
    public java.util.List<TransactionEvents.CreatePayoutEventResponse> getCreatePayoutEvents(org.web3j.protocol.core.methods.response.TransactionReceipt transactionReceipt) {
        ...
        java.util.ArrayList<TransactionEvents.CreatePayoutEventResponse> responses = new java.util.ArrayList<TransactionEvents.CreatePayoutEventResponse>(valueList.size());
        for (org.web3j.tx.Contract.EventValuesWithLog eventValues : valueList) {
    ...
    public io.reactivex.Flowable<TransactionEvents.CreatePayoutEventResponse> createPayoutEventFlowable(org.web3j.protocol.core.methods.request.EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new io.reactivex.functions.Function<org.web3j.protocol.core.methods.response.Log, TransactionEvents.CreatePayoutEventResponse>() {
            @Override
            public TransactionEvents.CreatePayoutEventResponse apply(org.web3j.protocol.core.methods.response.Log log) {
    ...
    public java.util.List<TransactionEvents.InvestEventResponse> getInvestEvents(org.web3j.protocol.core.methods.response.TransactionReceipt transactionReceipt) {
        ...
        java.util.ArrayList<TransactionEvents.InvestEventResponse> responses = new java.util.ArrayList<TransactionEvents.InvestEventResponse>(valueList.size());
        for (org.web3j.tx.Contract.EventValuesWithLog eventValues : valueList) {
    ...
    public io.reactivex.Flowable<TransactionEvents.InvestEventResponse> investEventFlowable(org.web3j.protocol.core.methods.request.EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new io.reactivex.functions.Function<org.web3j.protocol.core.methods.response.Log, TransactionEvents.InvestEventResponse>() {
            @Override
            public TransactionEvents.InvestEventResponse apply(org.web3j.protocol.core.methods.response.Log log) {
    ...
    public java.util.List<TransactionEvents.TransferEventResponse> getTransferEvents(org.web3j.protocol.core.methods.response.TransactionReceipt transactionReceipt) {
        ...
        java.util.ArrayList<TransactionEvents.TransferEventResponse> responses = new java.util.ArrayList<TransactionEvents.TransferEventResponse>(valueList.size());
        for (org.web3j.tx.Contract.EventValuesWithLog eventValues : valueList) {
    ...
    public io.reactivex.Flowable<TransactionEvents.TransferEventResponse> transferEventFlowable(org.web3j.protocol.core.methods.request.EthFilter filter) {
        return web3j.ethLogFlowable(filter).map(new io.reactivex.functions.Function<org.web3j.protocol.core.methods.response.Log, TransactionEvents.TransferEventResponse>() {
            @Override
            public TransactionEvents.TransferEventResponse apply(org.web3j.protocol.core.methods.response.Log log) {
